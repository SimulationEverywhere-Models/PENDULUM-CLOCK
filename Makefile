...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  AgujaHour.o AgujaMin.o Alarma.o ControlEncendido.o Pendulo.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
AgujaHour.o: /cygdrive/C/eclipse/workspace/test/AgujaHour.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
AgujaMin.o: /cygdrive/C/eclipse/workspace/test/AgujaMin.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Alarma.o: /cygdrive/C/eclipse/workspace/test/Alarma.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
ControlEncendido.o: /cygdrive/C/eclipse/workspace/test/ControlEncendido.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Pendulo.o: /cygdrive/C/eclipse/workspace/test/Pendulo.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
...
#^|
AgujaHour.o: /cygdrive/C/eclipse/workspace/test/AgujaHour.cpp \
 /cygdrive/C/eclipse/workspace/test/AgujaHour.h \
...
AgujaMin.o: /cygdrive/C/eclipse/workspace/test/AgujaMin.cpp \
 /cygdrive/C/eclipse/workspace/test/AgujaMin.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/strutil.h
Alarma.o: /cygdrive/C/eclipse/workspace/test/Alarma.cpp \
 /cygdrive/C/eclipse/workspace/test/Alarma.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/strutil.h
ControlEncendido.o: \
 /cygdrive/C/eclipse/workspace/test/ControlEncendido.cpp \
 /cygdrive/C/eclipse/workspace/test/ControlEncendido.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/strutil.h
Pendulo.o: /cygdrive/C/eclipse/workspace/test/Pendulo.cpp \
 /cygdrive/C/eclipse/workspace/test/Pendulo.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
